...
::: {.callout-note title="Exemplo 11"}
Seja $X \sim Binomial(n, p)$. Encontre sua função característica e, através dela, encontre $E(X)$ e $\text{Var}(X)$.
:::
...
Seja $X \sim N(\mu, \sigma^2)$. Encontre sua função característica e, através dela, encontre $E(X)$ e $\text{Var}(X)$.
:::
